...
const CategoriesPage = () => {
    ...
    const fetchCategories = async () => {
        ...
        try {
            ...
            const url = `http://localhost:5000/categories?${queryParams.toString()}`;
    ...
    if (error) {
        return <StatusDisplay type="error" message={error} onRetry={handleCategoryChange} />;
    }

    return (
        <div className="flex flex-col">
            <div className="bg-white shadow-md rounded-lg p-4 mb-6">
                <h2 className="text-2xl font-semibold text-gray-800 mb-4">Filter & Sort Categories</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        <label htmlFor="filterName" className="block text-gray-700 text-sm font-medium mb-1">Search by Name</label>
                        <input
                            id="filterName"
                            type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md md:col-span-1">
                    ...
                    {categories.length === 0 && !pageLoading ? (
                        <StatusDisplay type="empty" message="No categories match your criteria. Try adjusting filters or add a new category!" emptyActionText="Add a Category" />
                    ) : (
                        <CategoryList
